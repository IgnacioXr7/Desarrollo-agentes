...
class LGymClient:
    ...
    def _precessingPerception(self, data):
        ...
        if len(attributes) > 0:
            ...
            elif self.IsCommand("perception",attributes) :
                if not "parameters" in attributes:
                    return False, attributes["gameover"] == "True", attributes["destroyed"] == "True", False
            ...
            if client.commandInit():
                ...
                while not finish:
                    ...
                    if gameover == True:
                        ...
                        win = True
                        if debug :
                            print("Game over, hemos ganado ",agentName)
                    elif destroyed == True:
                        finish = True
                        win = False
                        if debug :
                            print("El Agente ha sido destruido ",agentName)
                    else:
                        if debug :
